...
var CurrentTime: UInt64; pcx, pcz, cx, cz: Integer;
begin
Update(Config.DeltaTime);
// Предгенерация чанков вокруг игрока (убирает фризы при ходьбе)
...
const LEFT_MARGIN = 3; LINE_SPACING = 28;
var TopRect, SideRect, BottomRect: TRect; TopHeight, vw, vh, LineY, FPSY, TextW: Integer; FPSText: string;
begin
...
FRenderer.DrawClouds(Bitmap, TopRect, FPlayer, False);
