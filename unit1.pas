...
uses
  ...
  Graphics, ExtCtrls, Types, uGame, uRenderer;  // Добавлен модуль Types
...
begin
  ...
  try
    ...
    // Теперь Rect доступен через модуль Types – используем без префикса
    FGame.Render(Bmp, Rect(0, 0, VIEW_WIDTH, VIEW_HEIGHT));
